...
The interface above this stage is the one it has always been — `suspend fun listen(): String?`, one utterance in, one transcript out. Nothing in the NLU layer, the dispatcher or any Sock knows which engine produced the string.
